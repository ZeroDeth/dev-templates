...
```shell
nix flake init --template github:zerodeth/dev-templates#${ENV}
```
...
nix flake init --template github:zerodeth/dev-templates#rust

# Create a new project
nix flake new --template github:zerodeth/dev-templates#rust ${NEW_PROJECT_DIRECTORY}
```
